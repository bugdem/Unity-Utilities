    ...
    public class PathMovementEditor : UnityEditor.Editor
    {
        ...
        protected virtual void OnSceneGUI()
        {
            ...
            for (int i = 0; i < t.Waypoints.Count; i++)
            {
                ...
                var fmh_48_69_637928107896176695 = Quaternion.identity; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint, .5f, new Vector3(.25f, .25f, .25f), Handles.CircleHandleCap);
