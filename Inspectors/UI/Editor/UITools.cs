...
namespace GameEngine.Utils
{
    ...
    {
        [MenuItem("Clocknest Games/UI/Anchors to Corners %[", priority = 1001)]
        ...
        [MenuItem("Clocknest Games/UI/Corners to Anchors %]", priority = 1002)]
        ...
        [MenuItem("Clocknest Games/UI/Mirror Horizontally Around Anchors %;", priority = 1003)]
		static void MirrorHorizontallyAnchors()
        {
            MirrorHorizontally(false);
        }

        [MenuItem("Clocknest Games/UI/Mirror Horizontally Around Parent Center %:", priority = 1004)]
        ...
        [MenuItem("Clocknest Games/UI/Mirror Vertically Around Anchors %'", priority = 1005)]
		static void MirrorVerticallyAnchors()
        {
            MirrorVertically(false);
        }

        [MenuItem("Clocknest Games/UI/Mirror Vertically Around Parent Center %\"", priority = 1006)]
